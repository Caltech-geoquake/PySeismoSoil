    ...
    def run(self, show_fig=False, return_fig_obj=False, **kwargs_to_plot):
        ...
        **kwargs_to_plot :
        ...
        if not np.allclose(af.freq, phf.freq):
            print(
                'Warning in SiteEffectAdjustment.run(): the frequency '
        ...
        transfer_function = (freq, (amp_tf, phase_tf))
