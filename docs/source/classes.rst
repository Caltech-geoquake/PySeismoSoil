...
PySeismoSoil defines several classes to represent different entities involved in site response analysis, such as the ``GroundMotion`` and ``VsProfile`` classes.
